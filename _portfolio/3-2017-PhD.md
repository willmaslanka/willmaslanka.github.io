...
$$k_e = (4\pi(F x 10^{9}))(sqrt(mu_{0} ep_{0} e'_{snow})(sqrt(0.5(sqrt(1+(ep''_{snow}/ep'_{snow})^{2}))-1)) + 0.0065(D_{o})^{2.12}(F)^{2.12}$$

where F is frequency (GHz), $mu_{o}$ is the permeability of free space (4$\pi$ x 10$^{-7}$ Hm$^{-1}$), ep$_{0}$ is the permittivity of free space (8.85x10$^{-12}$ F m$^{-1}$), ep'$_{snow}$ and ep''$_{snow} are the real and imaginary parts of the permittivity of dry snow respectively, and D$_{o}$ is the optical diameter (mm, inversely proportional to the Specific Surface Area).)
